...
contract DellasInu is ERC20, Ownable {
    ...
    constructor() ERC20("Dellas Inu", "DELLINU") {
    ...
    if (canSwap && !swapping && from != owner() && to != owner()  && !_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
        swapping = true;
